          ...
          <div class="col-md-6 mb-4">
            ...
            <form action="validation.php" method="post">
              <div class="form-group py-3">
                ...
                <input name="name" type="text" class="form-control border-bottom border-0 border py-3" id="name" onkeyup="validateName()"  placeholder="Enter your name">
                
              </div>
              <div class="form-group py-3">
                <label for="email">Email<span class="span-validation ps-3 text-danger" id="email-error"></span></label>
                <input name="mail" type="email" class="form-control border-bottom border-0 border py-3" id="mail" onkeyup="validateEmail()"placeholder="Enter your email address">
                
              </div>
              <div class="form-group py-3">
                <label for="phone">Phone Number<span class="span-validation ps-3 text-danger" id="phone-error"></span></label>
                <input name="phone" type="tel" class="form-control border-bottom border-0 border py-3" id="phone" onkeyup="validatePhone()"  placeholder="Enter your phone number">
                
              </div>
              <div class="form-group py-3">
                <label for="subject">Subject</label>
                <select name="subject" class="form-control border-bottom border-0 border py-3" id="subject" >
              ...
              <div class="form-group py-3">
                ...
                <textarea name="body" class="form-control border-bottom border-0 border py-3" id="message" onkeyup="validateMessage()" name="message" rows="3" placeholder="Enter your message here"></textarea>
              </div>
              <button name="submit" type="submit" class="btn btn-primary py-3 ">Send</button>
